...
class CacheUtilsTest {
    ...
    void test01() {
        ...
        Function<List<String>, List<User>> dbFun = keys -> Stream.of(
        ...
        List<User> users = CacheUtils.initMultiCacheBuilder(dbFun)
                ...
                .opNoCacheStrategyHandle(list -> list != null && list.size() > 10)
                .opExpireTime(30000L)
                .handler().apply(userIds);
